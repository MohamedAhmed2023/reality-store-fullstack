...
import "./Footer.css";
import img1 from "./Assets/icons/Mobile App.png";
import img2 from "./Assets/icons/Mobile App (1).png";
const Footer = () => {
  return (
    <>
      <div className="Footer flex space__around pz__15">
        ...
        <div className="footer1st">
          ...
          <div className="location flex py__10">
            ...
            <strong>Email:</strong>
            <h6> E-commerceOnline@gmail.com</h6>
          </div>
          <div className="location flex py__10">
            <svg
              xmlns="http://www.w3.org/2000/svg"
